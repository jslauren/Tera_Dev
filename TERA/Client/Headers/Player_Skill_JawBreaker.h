...
class CPlayerState;
class CPlayer_Skill_JawBreaker : public CPlayerState
{
protected:
	explicit CPlayer_Skill_JawBreaker(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CPlayer_Skill_JawBreaker() = default;
...
public:
	static CPlayer_Skill_JawBreaker*	Create(LPDIRECT3DDEVICE9 pGraphicDevice, CPlayer& Player, void* pArg = nullptr);
	virtual void						Free();
