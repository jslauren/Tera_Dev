...
class CPlayerState;
class CPlayer_Skill_CuttingSlash : public CPlayerState
{
public:
	explicit CPlayer_Skill_CuttingSlash(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CPlayer_Skill_CuttingSlash() = default;
