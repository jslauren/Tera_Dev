...
class CPlayerState;
class CPlayer_Skill_DrawSword_End : public CPlayerState
{
public:
	explicit CPlayer_Skill_DrawSword_End(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CPlayer_Skill_DrawSword_End() = default;
...
public:
	static CPlayer_Skill_DrawSword_End*		Create(LPDIRECT3DDEVICE9 pGraphicDevice, CPlayer& Player, void* pArg = nullptr);
	virtual void							Free();
