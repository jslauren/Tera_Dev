...
class CPlayerState;
class CPlayer_Skill_GaiaCrush : public CPlayerState
{
public:
	explicit CPlayer_Skill_GaiaCrush(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CPlayer_Skill_GaiaCrush() = default;
...
public:
	static CPlayer_Skill_GaiaCrush*	Create(LPDIRECT3DDEVICE9 pGraphicDevice, CPlayer& Player, void* pArg = nullptr);
	virtual void					Free();
