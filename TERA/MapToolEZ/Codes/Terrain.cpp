...
HRESULT CTerrain::Add_Component()
{
	...
	// For.Com_Buffer
	if (FAILED(CGameObject::Add_Component(SCENE_PROTO, L"Component_Buffer_Terrain", L"Com_Buffer", (CComponent**)&m_pBufferCom)))
		return E_FAIL;
	...
	// For.Com_Texture
	if (FAILED(CGameObject::Add_Component(SCENE_PROTO, L"Component_Texture_Terrain", L"Com_Texture", (CComponent**)&m_pTextureCom)))
		return E_FAIL;
